...
An Arduino-based controller that allows the Yaesu ATAS-120 HF mobile antenna to be used with **any transceiver**, while providing improved mechanical protection compared to the other implementations.
